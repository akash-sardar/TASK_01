...
# Create user defined function to chunk data from PySpark dataframe
...
class Chunking:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact) -> ChunkingArtifact:
        """
    ...
    def read_saved_data_into_dataframe(self):
        ...
        """
        df_all_companies = self.spark.read.parquet(self.data_ingestion_artifact.corpus_file_path)
    ...
    def custom_text_splitter(self):
        ...
        try:
            ...
            for section_name in columns:
                ...
                df_section = df_section.select("cik", "filename", "chunk", "section_name", "chunk_id")
